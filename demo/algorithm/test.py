        ...
        for triplet in self.tripleListTest:
            ...
            for i in nameRank:
                if i[0] == triplet[2]:
                    break
                x += 1
            self.rank.append((triplet, triplet[2], nameRank[0][0], x, x/len(nameRank)))
            print(x)
            cou += 1
            if cou % 10000 == 0:
                print(cou)
...
if __name__ == '__main__':
    ...
    print(testHeadRaw.getMeanRank())
    testHeadRaw.writeRank(path+"/test/testRelationRaw" + ".txt")
